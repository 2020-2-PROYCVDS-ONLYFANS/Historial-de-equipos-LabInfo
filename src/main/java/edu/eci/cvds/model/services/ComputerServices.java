...
public interface ComputerServices {
    ...
    Long getIdByElementId(ElementTypeName typeName, Long elementId) throws ServicesException;
    ...
    Computer getComputerById(Long id) throws ServicesException;

    Computer getComputerByReference(String reference) throws ServicesException;

    List<Computer> getActiveComputers() throws ServicesException;
    ...
    void setElementIdByIds(ElementTypeName typeName, Long userId, Long elementId, Long computerId)
            throws ServicesException;

    void setReferenceById(Long userId, String reference, Long computerId) throws ServicesException;
